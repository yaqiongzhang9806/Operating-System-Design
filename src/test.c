...
void test26(void) {
    ...
    // OK - all disk activity from both child processes should now 
    // be complete.  Create a record of this disk activity for 
    // further analysis.  It should show both the Format and
    // directories created by test10, and the usage in the swap
    // area resulting from test25.
    CHECK_DISK(DiskID, &ErrorReturned);
